    ...
    <div class="dr-contentForm">
        <el-form :model="formState.formData" :rules="rules" ref="ruleForm" label-width="120px" class="demo-ruleForm">
            ...
            <el-tabs v-model="activeName" @tab-click="handleTabClick">
                ...
                <el-tab-pane label="信息流设置" name="feedsetup">
                    ...
                    <el-form-item label="信息流类型" prop="type">
                        <el-cascader size="small" expand-trigger="hover" :options="feedtypeoption"
                                     v-model="formState.formData.fstype" @change="handleChangeFeedstype">
                        </el-cascader>
                    </el-form-item>
                ...
                <el-tab-pane label="发布设置" name="publishopt">
                    ...
                    <el-form-item label="文章类别" prop="categories">
                        <el-cascader size="small" expand-trigger="hover" :options="contentCategoryList.docs"
                                     v-model="formState.formData.categories" @change="handleChangeCategory"
                                     :props="categoryProps">
                        </el-cascader>
                    </el-form-item>
                    <el-form-item label="立即发布" prop="state">
...
<script>
    ...
    import {fstype} from "../../../../utils/fstype";
