...
router.post("/upload", function (req, res, next) {
	...
	//存放目录
	let updatePath = settings.UPLOAD_IMG_DIR;
	let smallImgPath = settings.UPLOAD_SMALLIMG_DIR;
	let newFileName = "";
	...
	form.on("field", function (field, value) {
		...
		let typeKey = "others";
		let thisType = file.name.split(".").pop();
		let date = new Date();
		...
		// }else{
		res.end( settings.imgserver_path + "/upload/images/" + newFileName);
		// }
